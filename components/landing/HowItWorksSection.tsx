...
export default function HowItWorksSection() {
  ...
  const { ref: stepsRef, isVisible: stepsVisible } = useScrollAnimationWithDelay(200);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Get started in just 4 simple steps and begin earning rewards for your sustainable driving
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, index) => (
              <motion.div
                ...
                animate={stepsVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              ...
              >
                ...
                <Card className="hover-lift backdrop-blur-sm border-2 border-transparent hover:border-primary/20 overflow-hidden relative group">
                  ...
                  <div className={`absolute inset-0 ${step.gradient} opacity-5 group-hover:opacity-10 transition-opacity duration-300`}></div>
                  ...
                  <CardHeader className="text-center relative z-10">
                    ...
                    <CardTitle className={`text-xl font-bold ${step.textGradient}`}>
                      {step.title}
                    </CardTitle>
                  </CardHeader>
        ...
        <motion.div
          ...
          animate={stepsVisible ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
        ...
        >
          <div className="inline-block p-8 gradient-ocean rounded-3xl backdrop-blur-sm shadow-2xl">
            ...
            <p className="text-black/90 text-lg mb-6 max-w-md">
              Join the revolution of sustainable driving and start earning rewards today
            </p>
            <motion.button
